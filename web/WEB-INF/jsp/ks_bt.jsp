<%-- 
    Document   : ks_bt
    Created on : Oct 24, 2018, 10:24:55 AM
    Author     : QUOCTRONG
--%>
...
<link href="resource/css/css_canho.css" rel="stylesheet"/>
</head>
...
<div class="header">
<div class="image">
<img src="resource/image/logo.png" style="width:300px; height:100px; margin-top:1px">
</div>
<div id="menu">
  <ul>
    <li><a href="#"><img src="resource/image/index.png" style="width:30px; height:30px; margin-top:10px"></br><span style="color:black">TRANG CHỦ</span></a></li>
    <li><a href="#"><img src="resource/image/building.png" style="width:30px; height:30px; margin-top:10px"></br><span style="color:black">CĂN HỘ</span></a></li>
    <li><a href="#"><img src="resource/image/house.jpg" style="width:30px; height:30px; margin-top:10px"></br><span style="color:black">NHÀ NGUYÊN CĂN</span></a></li>
    <li><a href="#"><img src="resource/image/motel.png" style="width:30px; height:30px; margin-top:10px"></br><span style="color:black">NHÀ TRỌ</span></a></li>
    <li><a href="#"><img src="resource/image/plus.jpg" style="width:30px; height:30px; margin-top:10px"></br><span style="color:black">KHÁC</span></a>
      <ul class="sub-menu">
    ...
    <li><a href="#"><img src="resource/image/blog.png" style="width:30px; height:30px; margin-top:10px"></br><span style="color:black">BLOG</span></a></li>
    <li><a href="#"><img src="resource/image/mess.png" style="width:30px; height:30px; margin-top:10px"></br><span style="color:black">ĐĂNG TIN</span></a></li>
  </ul>
</div>
</div>
<div class="body">
